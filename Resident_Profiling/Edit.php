...
<body style="font-family: calibri; font-size: 18px;">
  ...
  <form method="POST" enctype="multipart/form-data" action="<?php htmlspecialchars("PHP_SELF"); ?>">
    ...
    <div required class="form-group col-md-4">
      ...
      <input type="text" maxlength="20" class="form-control" id="res_fname" name="new_fname" placeholder="First name"
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" maxlength="20" class="form-control" id="res_mname" name="new_mname" placeholder="Middlename"
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" maxlength="20" class="form-control" id="res_lname" name="new_lname" placeholder="Lastname"
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" maxlength="11" class="form-control" id="res_contactnum" name="res_contactnum"
    ...
    <div class="form-group col-md-2">
      ...
      <input type="number" class="form-control" id="res_height" name="new_height" placeholder="Meter/Centimeter"
        value="<?php echo $db_res_Height; ?>">
    </div>

    <div class="form-group col-md-2">
      <label for="res_lname">Weight</label>
      <input type="number" class="form-control" id="res_weight" name="new_weight" placeholder="Kilogram"
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" maxlength="20" class="form-control" id="res_trabaho" name="res_trabaho"
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" maxlength="20" class="form-control" id="res_unit" name="new_addressUnit"
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" maxlength="15" class="form-control" id="res_building" name="new_addressBuilding"
        value="<?php echo $db_res_build; ?>" placeholder="Building name">
    </div>

    <div class="form-group col-md-2">
      <label for="res_lot">Lot</label>
      <input type="text" maxlength="15" class="form-control" id="res_lot" name="res_addressLot"
        value="<?php echo $db_res_lot; ?>" placeholder="Lot">
    </div>

    <div class="form-group col-md-2">
      <label for="res_block">Block</label>
      <input type="text" maxlength="15" class="form-control" id="res_block" name="new_addressBlock"
        value="<?php echo $db_res_block; ?>" placeholder="Block">
    </div>

    <div class="form-group col-md-2">
      <label for="res_phase">Phase</label>
      <input type="text" maxlength="15" class="form-control" id="res_phase" name="new_addressPhase"
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" maxlength="15" class="form-control" id="res_houseno" name="new_addressHouse"
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" maxlength="15" class="form-control" id="res_street" name="new_addressStreet"
        value="<?php echo $db_res_street; ?>" placeholder="Street">
    </div>

    <div class="form-group col-md-3">
      <label for="res_subdmname">Subdivision</label>
      <input type="text" maxlength="20" class="form-control" id="res_subd" name="new_addressSubdi"
    ...
    <button type="button" onclick="location.href='resident.php'" class="btn btn-danger  col-lg-offset-5"><span
