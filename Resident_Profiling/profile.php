          ...
          <div class="panel-body">
            ...
            <div class="box box-info">
              ...
              <div class="box-body">
                ...
                <div class="col-sm-7"><?php echo $db_res_cnum; ?></div>
                ...
                <div class="col-sm-7">
                  <?php echo $db_res_unit . ", " . $db_res_build . ", L" . $db_res_lot . ", BLK" . $db_res_block . ", PH" . $db_res_phase . ", " . $db_res_house . ", " . $db_res_street . " Street, " . $db_res_sub . ", " . $db_res_pur . " , Indang, Cavite"; ?>
                </div>
            ...
            <div class="panel-body">
              ...
              <div class="box box-info">
                <form method="POST" action="<?php htmlspecialchars("PHP_SELF"); ?>">
                  ...
                  <div class="row-bttn">
                    <button type="button" onclick="location.href='resident-select-mother.php'" id="show_button"
                      class="btn btn-success btn-sm col-lg-offset-4">
                      Select Mother
                    </button>
                    <br>
