          ...
          <div class="panel-body">
            ...
            <div class="box box-info">
              ...
              <div class="box-body">
                ...
                <div class="col-sm-6">
                  <h3 style="color:#00b1b1; "><?php echo $db_res_fname; ?>&nbsp;<?php echo $db_res_mname; ?>&nbsp;
                    <?php echo $db_res_lname; ?>
                  </h3>
                  <span>
                    <p><b> Resident ID: <?php echo $db_res_id; ?></b></p>
                  </span>
                </div>
                ...
                <div class="col-sm-5 col-xs-6 tital ">Sex:</div>
                <div class="col-sm-7 col-xs-6 "><?php echo $db_res_gen; ?></div>
                <div class="clearfix"></div>
                <div class="bot-border"></div>

                <div class="col-sm-5 col-xs-6 tital ">Birthday:</div>
                <div class="col-sm-7"> <?php echo $db_res_bdate; ?></div>
                <div class="clearfix"></div>
                <div class="bot-border"></div>

                <div class="col-sm-5 col-xs-6 tital ">Age:</div>
                <div class="col-sm-7"> <?php echo $age; ?> </div>
                <div class="clearfix"></div>
                <div class="bot-border"></div>



                <div class="col-sm-5 col-xs-6 tital ">Civil Status:</div>
                <div class="col-sm-7"><?php echo $db_res_mstat; ?></div>
                ...
                <div class="col-sm-7"><?php echo $db_res_rel; ?></div>
                ...
                <div class="col-sm-7 col-xs-6 "><?php echo $db_res_height; ?></div>
                <div class="clearfix"></div>
                <div class="bot-border"></div>

                <div class="col-sm-5 col-xs-6 tital ">Weight:</div>
                <div class="col-sm-7 col-xs-6 "><?php echo $db_res_weight; ?></div>
                <div class="clearfix"></div>
                <div class="bot-border"></div>


                <div class="col-sm-5 col-xs-6 tital ">Citizenship:</div>
                <div class="col-sm-7"><?php echo $db_res_citi; ?></div>

                <div class="clearfix"></div>
                <div class="bot-border"></div>

                <div class="col-sm-5 col-xs-6 tital ">Contact No.:</div>
                <div class="col-sm-7"><?php echo isset($db_res_cnum); ?></div>
                ...
                <div class="col-sm-7">
                  <?php echo $db_res_unit . ", " . $db_res_build . ", L" . $db_res_lot . ", BLK" . $db_res_block . ", PH" . $db_res_phase . ", " . $db_res_house . ", " . $db_res_street . " Street, " . $db_res_sub . ", " . $db_res_pur . ", Calumpang Cerca" . ", Indang, Cavite"; ?>
                </div>

                <div class="clearfix"></div>
                <div class="bot-border"></div>

                <div class="col-sm-5 col-xs-6 tital ">Occupation Status:</div>
                <div class="col-sm-7"><?php echo $db_res_ocst; ?></div>
                <div class="clearfix"></div>
                <div class="bot-border"></div>

                <div class="col-sm-5 col-xs-6 tital ">Occupation:</div>
                <div class="col-sm-7"><?php echo $db_res_occ; ?></div>


                <div class="clearfix"></div>
                <div class="bot-border"></div>

                <div class="col-sm-5 col-xs-6 tital ">Mother:</div>
                <div class="col-sm-7"><?php echo $db_mother_fName . " " . $db_mother_mName . " " . $db_mother_lName; ?>
                </div>
                ...
                <div class="col-sm-5 col-xs-6 tital ">Father:</div>
                <div class="col-sm-7"><?php echo $db_father_fName . " " . $db_father_mName . " " . $db_father_lName; ?>
                </div>
                ...
                <div id="signup">
                  ...
                  <form hidden action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" id="form1">
                    <div required class="form-group col-md-4">
                      ...
                      <input type="hidden" maxlength="20" class="form-control" id="dethId" name="deathId"
                        value="<?php echo $user_id; ?>">
                    </div>
                    <br>
                    <div required class="col-lg-offset-1 form-group col-md-5">
                      <label for="res_fname">Cause of Death</label>
                      <input type="text" maxlength="20" class="form-control" id="cause" name="cause"
                        placeholder="Cause of Death" required>
                    </div>

                    <div class="form-group col-md-4">
                      <label for="res_bdate">Date of Death</label>
                      <input placeholder="Date of Death" class="form-control" type="date" id="ddate" name="ddate">
                      <!-- onblur="(this.type='text')" -->
                    </div>
                    <div class="clearfix"></div>
                    <center> <input type="submit" name="signup" id="insert" value="Insert" class="btn btn-info" />
                    </center>
                  </form>
                </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <input placeholder="Birthdate" class="form-control" type="hidden" onfocus="(this.type='date')"
                    id="res_bdate" name="res_bdate" value="<?php echo $db_res_bdate; ?>">
                  <!-- onblur="(this.type='text')" -->
                </div>
