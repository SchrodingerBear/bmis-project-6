...
<body style="padding: 25px;">
        ...
        <form method="POST" enctype="multipart/form-data" action="<?php htmlspecialchars("PHP_SELF"); ?>">
          ...
          <div class="modal-body">
            ...
            <div class="form-group col-md-4">
              ...
              <input value="63" required type="text" maxlength="11" class="form-control" id="res_contactnum"
            ...
            <div class="form-group col-md-4">
              ...
              <input type="number" class="form-control" id="res_height" name="res_height"
            ...
            <div class="form-group col-md-4">
              ...
              <input required type="number" maxlength="20" class="form-control" id="res_unit" name="res_unit"
                placeholder="Unit-Room-Floor">
            </div>


            <div class="form-group col-md-4">
              <label for="res_building">Building name</label>
              <input required type="text" maxlength="15" class="form-control" id="res_building" name="res_building"
            ...
            <div class="form-group col-md-4">
              ...
              <input required type="text" onkeypress="return isNumberKey(event)" maxlength="15" required
                class="form-control" id="res_houseno" name="res_houseno" placeholder="House number">
            </div>


            <div class="form-group col-md-4">
              <label for="res_street">Street</label>
              <input required type="text" maxlength="15" class="form-control" id="res_street" name="res_street"
                placeholder="Street">
            </div>
            ...
            <div class="form-group col-md-4">
              ...
              <select required class="form-control" id="res_purokno" name="res_purokno">
                ...
                while ($row = mysqli_fetch_array($res)) {
                  ?>
                  <option value="<?php echo $row["purok_ID"]; ?>"><?php echo $row["purok_Name"]; ?></option>
  ...
  <?php if ($_SESSION['position'] == 'Barangay Secretary'): ?>
    ...
    <button type="button" class="btn btn-info btn-lg pull-right" data-toggle="modal" data-target="#myModal">Add Resident
    </button>
  <?php endif; ?>
        ...
        <td>
          <div class="btn-group">
            ...
            <?php if ($_SESSION['position'] != "Barangay Captain") {
              echo '<a href="edit.php?id=' . $row['res_ID'] . '" class="btn btn-info btn-xs">Edit</a>';
            } ?>
          </div>
        </td>
      </tr>
