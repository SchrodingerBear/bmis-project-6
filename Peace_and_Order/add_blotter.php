                ...
                <div class="card">
                    ...
                    <form id="validateForm" action="" name="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea style="height:150px!important;" class="form-control"
                                            name="offender_description" id=""></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-7 col-sm-12">
                                    <div class="form-group">
                                        <label>Case</label>
                                        <div class="">
                                            <label class="radio-inline"><input type="radio" value="criminal"
                                                    name="optradio">&nbsp;Criminal&nbsp;&nbsp;&nbsp;</label>
                                            <label class="radio-inline"><input type="radio" value="civil"
                                                    name="optradio">&nbsp;Civil&nbsp;&nbsp;&nbsp;</label>
                                            <label class="radio-inline"><input type="radio" name="optradio"
                                                    id="other_case" value="other">&nbsp;Others&nbsp;&nbsp;&nbsp;</label>
                                            <input type="text" class="form-control" name="case" id="case_input"
                                                style="display:none;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea style="height:250px!important;" class="form-control" name="narrative"
                                            id=""></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer clearfix">
                            <button type="submit" name="save" value="insert"
