$(function () {
            ...
            if (!complainantExist) {
              $.ajax({
                ...
                success: function (data) {
                  ...
                  if (
                    residentDetails[0].suffix !== null &&
                    residentDetails[0].suffix != 'N/A'
                  ) {
                  ...
                  $('input[name=contact_number]').val(
                    residentDetails[0].contact_telnum
                  )
                  $('select[name=gender]').append(
                    "<option selected value='" +
                      residentDetails[0].gender_Name.toLowerCase() +
                      "'>" +
                      residentDetails[0].gender_Name +
                      '</option>'
                  )
                  if (
                    residentDetails[0].address_Lot_No !== null &&
                    residentDetails[0].address_Block_No !== null &&
                    residentDetails[0].address_House_No !== null &&
                    residentDetails[0].address_Street_Name !== null &&
                    residentDetails[0].address_Subdivition !== null
                  ) {
                    $('input[name=address]').val(
                      residentDetails[0].address_House_No +
                        ' ' +
                        residentDetails[0].address_Street_Name +
                        ' ' +
                        residentDetails[0].address_Subdivision
                    )
                  }
            ...
            if (!complainantExist) {
              $.ajax({
                ...
                success: function (data) {
                  ...
                  $('select[name=offender_gender]').append(
                    "<option selected value='" +
                      residentDetails[0].gender_Name.toLowerCase() +
                      "'>" +
                      residentDetails[0].gender_Name +
                  ...
                  if (
                    ...
                    $('input[name=offender_address]').val(
                      residentDetails[0].address_House_No +
                        ' ' +
                        residentDetails[0].address_Street_Name +
                        ' ' +
  ...
  for (var k in violation) {
    var option =
      '<option value=' +
      violation[k].violation_ID +
      '>' +
      violation[k].violation_Name +
      '</option>'
  ...
  $('#updatePersonInvolve').validate({
    ...
    submitHandler: function () {
      ...
      if (
        resident_idComplainant > 0 &&
        resident_idComplainant !== 'undefined'
      ) {
        resident_id = resident_idComplainant
      } else if (
        resident_idOffender > 0 &&
        resident_idOffender !== 'undefined'
      ) {
